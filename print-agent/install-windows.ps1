...
$requiredFiles = @(
    "main.py", "config.py", "endpoints.py", "printer_profiles.py", "thermal_layout.py", "pairing.py", "worker.py", "wake_listener.py", "simulator.py", "dispatcher.py", "agent_runtime.py",
