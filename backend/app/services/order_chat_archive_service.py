"""Read model do histórico da Central de Conversas do Caixa.

O hot path mantém somente conversas ativas. Conversas encerradas são histórico
read-only; pedido terminal nunca reabre a thread como pós-venda.
"""
