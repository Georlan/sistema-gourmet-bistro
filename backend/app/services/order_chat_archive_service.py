"""Read model leve para fila ativa e histórico read-only do chat de pedidos.

Pedidos terminais nunca reabrem a conversa. O histórico pode ser consultado,
mas escrita pertence exclusivamente ao ciclo operacional do pedido.
"""
