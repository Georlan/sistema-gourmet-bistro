...
function Preview() {
  ...
  return (
    <main style={{ padding: 16, fontFamily: 'sans-serif' }}>
      ...
      <section aria-label="Prévia do tablet" style={{ background, padding: 12 }}>
        {mode === 'shell' ? (
          <img src={shell} alt="Moldura transparente do tablet" style={{ display: 'block', width: '100%', maxWidth: 820, margin: 'auto' }} />
        ) : (
          <EditableTabletFrame shellSrc={shell} screenshot={mode === 'a' || mode === 'b' ? captures[mode] : undefined}>
