...
export const SUBSCRIPTION_PAYMENT_OPTIONS: readonly SubscriptionPaymentOption[] = [
  {
    ...
    checkoutSummary: 'Autorize hoje sem cobrança. Depois da configuração, você escolhe quando iniciar seus 7 dias grátis.',
    landingSummary: 'Cartão recorrente com 7 dias grátis completos, iniciados por você depois da configuração.',
    previewTitle: 'Cartão de crédito',
    previewDescription: 'O cartão é autorizado sem cobrar a mensalidade fixa hoje. Depois da configuração, você inicia os 7 dias grátis; as cobranças seguintes são automáticas.',
    selectable: true,
  ...
  },
  {
    ...
    previewDescription: 'O KÔMA não cria cobrança antecipada. Depois que você iniciar e concluir os 7 dias grátis, o plano mensal gera um novo QR Code/Pix Copia e Cola a cada vencimento; no plano anual, um único Pix do total anual quita os próximos 12 meses.',
    selectable: true,
  ...
  },
  {
    ...
    previewDescription: 'A autorização ocorre no ambiente seguro do Mercado Pago. A mensalidade fixa continua R$ 0 hoje e a recorrência só começa depois do período grátis iniciado por você.',
    selectable: true,
    automaticRenewal: true,
  },
] as const;
