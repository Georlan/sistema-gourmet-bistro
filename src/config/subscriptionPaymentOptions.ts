...
export const SUBSCRIPTION_PAYMENT_OPTIONS: readonly SubscriptionPaymentOption[] = [
  {
    ...
    previewDescription: 'Fluxo implementado via Mercado Pago. A produção ainda precisa de homologação operacional das credenciais SaaS antes de ser considerada concluída.',
    selectable: true,
  },
  {
    id: 'pix_automatic',
