...
export const LEGAL_EFFECTIVE_DATE = '23/09/2026';

const SAAS_PAYMENT_METHODS: LegalSection = {
  title: '10. Contratação do SaaS, pagamento e liberação',
  paragraphs: [
    'A contratação do Pocket desta versão tem mensalidade fixa de R$ 39,90 e exige seleção de meio de pagamento disponível. Contratos anteriores com mensalidade fixa de R$ 0 preservam seus termos aceitos e não criam recorrência de valor zero no provedor.',
...
const FREE_TRIAL_TERMS: LegalSection = {
  ...
  paragraphs: [
    ...
    'Para Pocket, Pro e Premium, o teste começa quando o restaurante conclui os três passos essenciais indicados pelo KÔMA: dados básicos do estabelecimento, horários de funcionamento e ao menos um produto efetivamente publicado no catálogo.',
...
const COMMERCIAL_CATALOG: LegalSection = {
  ...
  bullets: [
    'Pocket: R$ 39,90 por mês + 1,79% sobre pagamentos online aprovados elegíveis.',
...
const COMMERCIAL_ANNUAL: LegalSection = {
  ...
  paragraphs: [
    'O Pocket desta versão é oferecido apenas no ciclo mensal, sem opção anual.',
...
const COMMERCIAL_PAYMENT_METHODS: LegalSection = {
  ...
  paragraphs: [
    'O Pocket desta versão possui componente fixo de R$ 39,90 por mês. O checkout apresenta os meios de pagamento disponíveis para esse componente.',
...
const COMMERCIAL_TRIAL: LegalSection = {
  ...
  paragraphs: [
    'O Pocket desta versão é elegível ao teste gratuito de 7 dias do componente fixo após a implantação essencial.',
    'Salvo oferta individual diferente, Pocket, Pro e Premium são elegíveis a 7 dias grátis no componente fixo após a conclusão da implantação essencial definida pelo KÔMA.',
