import {
  LEGAL_DOCUMENTS as LEGAL_V31_DOCUMENTS,
...
export const LEGAL_VERSION = '3.2';
...
const POCKET_PLAN: LegalSection = {
  ...
  bullets: [
    ...
    'Gestão de equipe com cadastro de pessoas, funções e permissões por cargo.',
    ...
    'Não inclui KDS dedicado e impressão automática, estoque/fichas técnicas/financeiro completo, app do entregador ou pontos, cashback e cupons.',
  ],
};
...
const PRO_PLAN: LegalSection = {
  title: '3. KÔMA Pro',
  bullets: [
    'Inclui todos os recursos do Pocket, inclusive App do Garçom e gestão de equipe.',
...
export const LEGAL_DOCUMENTS: LegalDocument[] = LEGAL_V31_DOCUMENTS.map((document) => {
