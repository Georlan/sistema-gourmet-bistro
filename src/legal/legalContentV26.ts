...
export const LEGAL_EFFECTIVE_DATE = '18/09/2026';

const SAAS_PAYMENT_METHODS: LegalSection = {
  title: '10. Contratação do SaaS, pagamento e liberação',
  paragraphs: [
    'A contratação do Pocket desta versão não exige assinatura recorrente para o componente fixo, porque sua mensalidade fixa é R$ 0. O KÔMA mantém o vínculo contratual, a assinatura canônica e as regras de acesso do SaaS sem criar recorrência de valor zero no provedor.',
    'Nos planos Pro e Premium, a contratação pode exigir seleção ou autorização prévia de meio de pagamento suportado para o componente fixo. A autorização, isoladamente, não representa cobrança, pagamento confirmado ou liberação automática do ambiente.',
...
const FREE_TRIAL_TERMS: LegalSection = {
  ...
  paragraphs: [
    ...
    'Salvo oferta individual diferente, novas contratações elegíveis de Pro e Premium recebem 7 dias completos de teste sem cobrança do componente fixo. O período não começa durante inscrição, aceite, criação de senha ou implantação inicial.',
    'Para Pro e Premium, o teste começa quando o restaurante conclui os três passos essenciais indicados pelo KÔMA: dados básicos do estabelecimento, horários de funcionamento e ao menos um produto efetivamente publicado no catálogo.',
...
const COMMERCIAL_CATALOG: LegalSection = {
  ...
  bullets: [
    'Pocket: R$ 0 por mês + 1,79% sobre pagamentos online aprovados elegíveis.',
...
const COMMERCIAL_ANNUAL: LegalSection = {
  ...
  paragraphs: [
    'O Pocket desta versão não possui componente fixo anual: sua mensalidade fixa é R$ 0 e não há desconto anual a aplicar sobre esse componente.',
    'Para Pro e Premium, a modalidade anual aplica 10% de desconto exclusivamente ao componente fixo. Valores desta versão: Pro R$ 1.393,20 por ano, equivalente a R$ 116,10 por mês; Premium R$ 2.689,20 por ano, equivalente a R$ 224,10 por mês.',
...
const COMMERCIAL_PAYMENT_METHODS: LegalSection = {
  ...
  paragraphs: [
    'O Pocket não exige meio de cobrança recorrente para mensalidade fixa nesta versão, porque o componente fixo contratado é R$ 0.',
...
const COMMERCIAL_TRIAL: LegalSection = {
  ...
  paragraphs: [
    ...
    'Salvo oferta individual diferente, Pro e Premium são elegíveis a 7 dias grátis no componente fixo após a conclusão da implantação essencial definida pelo KÔMA.',
