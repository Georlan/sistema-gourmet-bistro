                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-[#00b894] font-semibold mt-0.5">
                      + {formatPercentage(plan.splitFeeRate)} por pedido online pago
                    </div>
                  ...
                  <p className="text-[11px] text-koma-subtle">Tarifas do provedor de pagamento são cobradas separadamente.</p>
