        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg space-y-4 rounded-xl border border-[#1e293b] bg-koma-card p-6 shadow-2xl">
            ...
            <form onSubmit={handleSaveEdit} className="space-y-4 text-xs">
              ...
              <div className="rounded-lg border border-zinc-800 bg-koma-page p-3">
                <span className="block font-medium text-koma-secondary">Plano de recursos</span>
                <p className="mt-1 font-bold text-koma-foreground">{officialPlan(editingTenant.plan)?.name || editingTenant.plan || "Não disponível"}</p>
                <p className="mt-1 text-[10px] leading-relaxed text-koma-subtle">Mudança de plano não é permitida por esta edição genérica. Ela exige o fluxo canônico de assinatura para sincronizar contrato, billing, provider, taxa transacional, entitlements e auditoria.</p>
              </div>
