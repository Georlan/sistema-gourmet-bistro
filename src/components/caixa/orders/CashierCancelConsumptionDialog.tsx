        ...
        >
          ...
          >
            ...
            >
              <div>
                ...
                <h3
                  ...
                  className={clsx('mt-1', 'text-lg', 'font-bold', 'text-koma-foreground')}
                >
            ...
            <div className={clsx('grid', 'grid-cols-3', 'gap-2')}>
              <div
                className={clsx('rounded-xl', 'border', 'border-koma-border-subtle', 'bg-black/20', 'p-3')}
              >
            ...
            <label className={clsx('block', 'space-y-1.5')}>
              <span
                className={clsx('text-[9px]', 'font-bold', 'uppercase', 'tracking-wider', 'text-koma-subtle')}
              >
                Motivo obrigatório
              </span>
              <textarea
