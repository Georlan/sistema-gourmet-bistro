...
export interface SimulatedOrder {
  ...
  itens: string;
  total: number;
  canal: 'ifood' | 'site' | 'whats' | string;
  modalidade: 'delivery' | 'retirada' | string;
  pago: boolean;
  status: 'pendente' | 'analise' | 'producao' | 'pronto' | 'transito' | string;
  endereco?: string;
  criadoEm: string;
}
...
export interface DeliveryMotoboysTabProps {
  ...
  handleDespacharPedido: (orderId: string, motoboyId: number) => void;
  handleDespacharWhatsApp: (order: SimulatedOrder, motoboyId: string) => void;
  handleRevogarAcessoMotoboy: (motoboyId: string) => void;
  handleFinalizarPedido: (orderId: string) => void;
  novoMotoboyNome: string;
  setNewMotoboyNome: (v: string) => void;
  novoMotoboyTelefone: string;
  setNewMotoboyTelefone: (v: string) => void;
  handleCadastrarMotoboy: (e: React.FormEvent) => void;
}

export function DeliveryMotoboysTab({
  simulatedOrders,
  motoboys,
  selectedMotoboys,
  setSelectedMotoboys,
  handleDespacharPedido,
  handleDespacharWhatsApp,
