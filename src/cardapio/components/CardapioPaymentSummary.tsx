  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div className="min-w-0">
        ...
        <p className="mt-1 text-sm font-bold text-koma-foreground">{PAYMENT_LABELS[method]} <span className="font-normal text-koma-secondary">· {isOnlinePix ? 'online agora' : fulfillment === 'delivery' ? 'na entrega' : fulfillment === 'dine_in' ? 'no local' : 'na retirada'}</span></p>
